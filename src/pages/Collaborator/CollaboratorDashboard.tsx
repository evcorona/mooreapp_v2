...
export default function CollaboratorDashboard() {
  ...
  const { data } = useQuery<CollaboratorsData>(['self'], getSelf)
  const {
    data: missingActivities,
    isLoading,
    refetch,
  } = useQuery<string[]>(['missingActivities'], getMissingActivities)
  ...
  return (
    <>
      <SlideOver
        ...
        title={`Crear actividad - ${daySelected} `}
      >
